...
// LOGICAL
export const _OR = new Type(`operator`, `or`, `|`, [`logical`])
  .addLexical(OPERATOR_PRIORITY + 2, _EQUALS(`|`))
  .deriveSyntactical(2)
  .setInOrderBehaviour(arityInOrder)
export const _AND = new Type(`operator`, `and`, `&`, [`logical`])
  .addLexical(OPERATOR_PRIORITY + 1, _EQUALS(`&`))
  .deriveSyntactical(2)
  .setInOrderBehaviour(arityInOrder)

// RELATIONAL
export const EQUALS = new Type(`operator`, `equals`, `=`, [`logical`, `inequality`])
  .addLexical(OPERATOR_PRIORITY + 15, _EQUALS(`=`))
  .deriveSyntactical(2)
  .setInOrderBehaviour(arityInOrder)
export const GREATER_OR_EQUAL = new Type(`operator`, `greater_or_equal`, `>=`, [`logical`, `inequality`])
  .addLexical(OPERATOR_PRIORITY + 12, _EQUALS(`>=`))
  .deriveSyntactical(2)
  .setInOrderBehaviour(arityInOrder)
export const SMALLER_OR_EQUAL = new Type(`operator`, `smaller_or_equal`, `<=`, [`logical`, `inequality`])
  .addLexical(OPERATOR_PRIORITY + 12, _EQUALS(`<=`))
  .deriveSyntactical(2)
  .setInOrderBehaviour(arityInOrder)
export const GREATER = new Type(`operator`, `greater`, `>`, [`logical`, `inequality`])
  .addLexical(OPERATOR_PRIORITY + 11, _EQUALS(`>`))
  .deriveSyntactical(2)
  .setInOrderBehaviour(arityInOrder)
export const SMALLER = new Type(`operator`, `smaller`, `<`, [`logical`, `inequality`])
  .addLexical(OPERATOR_PRIORITY + 11, _EQUALS(`<`))
  .deriveSyntactical(2)
  .setInOrderBehaviour(arityInOrder)
...
export const MULTIPLICATION = new Type(`operator`, `multiplication`, `×`, [`arithmetic`])
  .addLexical(OPERATOR_PRIORITY + 107, _EQUALS(`*`))
  .deriveSyntactical(2)
  .setInOrderBehaviour(arityInOrder)
...
export const ADDITION = new Type(`operator`, `addition`, `+`, [`arithmetic`])
  .addLexical(OPERATOR_PRIORITY + 105, _EQUALS(`+`))
...
export const SIGN = new Type(`operator`, `sign`, `g`, [`arithmetic`, `numeric`, `quantity:numerical-value`, `literal:like`]) //
  .addSyntactical(OPERATOR_PRIORITY + 109, 1)
  .setInOrderBehaviour(arityInOrder)
