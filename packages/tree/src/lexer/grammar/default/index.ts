...
export const _IF = createEntry(KEYWORD_PRIORITY + 1, `if`, EQUALS(`@if`))
export const _THEN = createEntry(KEYWORD_PRIORITY + 2, `then`, EQUALS(`then`))
export const _ELSE = createEntry(KEYWORD_PRIORITY + 2, `else`, EQUALS(`else`))
