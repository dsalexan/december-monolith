...
import type { Maneuver as CustomManeuver } from "@december/gurps/maneuvers"
...
declare global {
  namespace GURPS {
    declare class Maneuvers {
      static createManeuver(data: ManeuverObject): Maneuver

      static listen(): void
      static getAll(): Record<OriginalManeuver | CustomManeuver, Maneuver>
      /**
       * @param {string} id
       *
      ...
      static getAllData(): Record<OriginalManeuver | CustomManeuver, ManeuverData>
      /**
       * @param {string} icon
       *
