...
import { DEFAULT_SYNTAX_COMPONENTS, SYNTAX_COMPONENTS } from "./syntax"
...
const parser = new TraitParser(originalEntry, [...DEFAULT_SYNTAX_COMPONENTS, SYNTAX_COMPONENTS.gca5_gives])
